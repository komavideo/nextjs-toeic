...
test("未回答ミッションは未回答専用導線で既回答をキューから除外する", () => {
  const question = firstQuestion("part5");
  const state = createProgressState([
    createAnswer({
      questionId: question.questionId,
