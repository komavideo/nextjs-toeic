...
1. ユーザーがダッシュボードを開く
2. 「5問クイック」または Part 別メニューを選ぶ
3. Part 5 は単問を5問、Part 6 / Part 7 はパッセージセットを1セッションとして出題する
4. ユーザーが各設問に回答する
...
| 5問クイックセッション | Phase 1 | Must | 隙間時間モードの中核 |
...
```ts
type ProgressStorageKey = "toeicReadingProgress:v1";
```
