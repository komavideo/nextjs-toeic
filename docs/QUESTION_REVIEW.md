...
| Part 7 | 196 | 49 | 49 | 49 | 49 |
| 全体 | 564 | 141 | 141 | 141 | 141 |
...
- 2026-06-30 最新受験情報に基づく100問追加確認結果: `p7-generated-set-072`〜`p7-generated-set-092` の本文、設問、選択肢、正解参照、解説、難易度、タグ、著作権・商標リスクを確認し、単一文書11セット・複数文書10セットのいずれも本文または文脈から正解を一意に説明できることを確認した。公式問題や市販教材の再現に見える表現は確認されなかった。
